...
part of the CodeLens app target, and several public-facing types still refer to
...
[`CodeLensTests/LocalAIFoundationTests.swift`](../../CodeLensTests/LocalAIFoundationTests.swift).
