...
final class MemoryPressureCoordinator {
    ...
    private func handleWarning() {
        ...
        NotificationCenter.default.post(name: .codeLensDropDiscardableCaches, object: nil)
    }
...
extension Notification.Name {
    ...
    static let codeLensDropDiscardableCaches = Notification.Name("codeLensDropDiscardableCaches")
}
