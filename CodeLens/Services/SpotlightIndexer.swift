...
// CodeLensApp via `onContinueUserActivity(CSSearchableItemActionType)`.

enum SpotlightIndexer {

    static let domain = "com.codelens.conversation"
    ...
    private static func searchableItem(for c: StoredConversation) -> CSSearchableItem {
        ...
        attr.keywords = ["chat", "codelens", "ai", "conversation", "assistant"]
