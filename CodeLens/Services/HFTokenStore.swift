...
//
// Storage: Generic password under service "com.codelens.huggingface".
...
final class HFTokenStore: ObservableObject {
    ...
    private let service = "com.codelens.huggingface"
    ...
    nonisolated static func authorizationHeaderValue() -> String? {
        ...
        let query: [String: Any] = [
            kSecClass as String:       kSecClassGenericPassword,
            kSecAttrService as String: "com.codelens.huggingface",
