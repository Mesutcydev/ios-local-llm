...
final class AppBridge: ObservableObject {
    ...
    static let appGroupID = "group.com.codelens.shared"
    ...
    struct SharedTextPayload: Equatable {
        ...
        /// the "Ask CodeLens" App Intent so a Siri/Shortcuts request actually
    ...
    /// Handles `codelens://share?...` URLs from the share extension.
    ...
    func handleIncomingURL(_ url: URL) {
        guard url.scheme == "codelens", url.host == "share" else { return }
    ...
    /// `codelens://share?file=…` is a PUBLIC custom URL scheme — any app or web
