...
struct AttributionsView: View {
    ...
    private var headerSection: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("CodeLens is built on the work of many researchers and engineers who released their models, frameworks, and tools openly. Each is listed below with its license and source.")
                .font(T.sans(11))
