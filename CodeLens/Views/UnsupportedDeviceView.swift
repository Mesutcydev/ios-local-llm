            ...
            ScrollView {
                VStack(spacing: 28) {
                    ...
                    VStack(spacing: 10) {
                        ...
                        Text("CodeLens runs large AI models entirely on-device. Inference needs at least 8 GB of physical RAM to load without thermal throttling or Jetsam kills.")
                            .font(T.sans(13))
