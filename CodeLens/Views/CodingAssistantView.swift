...
struct CodingAssistantView: View {
    ...
    private func consumeSharedText() {
        ...
        // "Ask CodeLens" App Intent path: fire the prompt automatically so a
                ...
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    VStack(alignment: .leading, spacing: 14) {
                        riskRow(
                            ...
                            text: "iOS may terminate CodeLens while the model loads or generates."
                        )
                        riskRow(
