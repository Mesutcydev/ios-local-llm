...
// Every screen in CodeLens should compose these instead of one-off styling.
...
// MARK: - Wordmark (kodu/CodeLens monogram)

struct KWordmark: View {
    var name: String = "codelens"
...
struct MarqueeText: View {
    ...
    private func lineHeight() -> CGFloat {
        // Heuristic for the common font sizes used in CodeLens. A
